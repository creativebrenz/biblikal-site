			...
			<div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
				...
				<div class="off-canvas-content" data-off-canvas-content>
					...
					<header class="header" role="banner">
						<div id="title-header">
							<img src="<?php echo get_template_directory_uri(); ?>/assets/images/header.jpg" alt="header">
							<ul id="social-header" class="menu simple">
								...
								<li><a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/youtube.png" alt=""></a></li>
							</ul>
						</div>
